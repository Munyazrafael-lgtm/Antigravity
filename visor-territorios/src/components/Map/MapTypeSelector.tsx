...
export type MapMode = 'm' | 's' | 'gallery';
...
export const MapTypeSelector: React.FC<MapTypeSelectorProps> = ({ onSelect, onCancel }) => {
  return (
    <div className="notes-modal-container glass-card" style={{ maxWidth: '350px', padding: '2rem' }} onClick={(e: MouseEvent) => e.stopPropagation()}>
